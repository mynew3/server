...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_BATTLEGROUND_REWARD_ITEMID,
    CONFIG_UINT32_BATTLEGROUND_REWARD_WIN,
    CONFIG_UINT32_BATTLEGROUND_REWARD_LOSE,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_BATTLEGROUND_CROSSFACTION_ENABLED,
    CONFIG_BOOL_BATTLEGROUND_REWARD_HONOR_SAMETEAMS,
