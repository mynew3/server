...
struct VendorItem
{
    VendorItem(uint32 _item, uint32 _maxcount, uint32 _incrtime, uint32 _ExtendedCost, uint32 _ReqArenaRating, uint32 _ReqArenaPoints, uint32 _ReqItem1, uint32 _ReqItem2)
        : item(_item), maxcount(_maxcount), incrtime(_incrtime), ExtendedCost(_ExtendedCost), ReqArenaRating(_ReqArenaRating), ReqArenaPoints(_ReqArenaPoints), ReqItem1(_ReqItem1), ReqItem2(_ReqItem2){}
...
struct VendorItemData
{
    ...
    void AddItem(uint32 item, uint32 maxcount, uint32 ptime, uint32 ExtendedCost, uint32 ReqArenaRating, uint32 ReqArenaPoints, uint32 ReqItem, uint32 ReqItem2)
    {
        m_items.push_back(new VendorItem(item, maxcount, ptime, ExtendedCost, ReqArenaRating, ReqArenaPoints, ReqItem, ReqItem2));
    }
