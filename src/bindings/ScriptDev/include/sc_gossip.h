...
#define ICON_CHAT_BUBBLE        0 // Chat bubble
#define ICON_BAG                1 // Bag
#define ICON_FLY                2 // Fly
#define ICON_BOOK               3 // Book
#define ICON_GEAR1              4 // Gear1
#define ICON_GEAR2              5 // Gear2
#define ICON_BAG_COIN           6 // Bag with coin
#define ICON_CHAT_BUBBLE_DOTS   7 // Chat bubble with dots
#define ICON_TABARD             8 // Tabard
#define ICON_CROSSING_SWORDS    9 // Crossing swords
#define ICON_YELLOW_DOT         10// Yellow dot
